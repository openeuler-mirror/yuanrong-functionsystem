...
cc_library(
    ...
    # libcurl, libssl, libcrypto, libgrpc*, libsecurec, libtbb, libzmq, libbrpc,
    # libgflags inside this package are runtime copies linked by datasystem.so
    # itself. They are picked up by the filter_files_with_suffix glob below.
    srcs = [
