...
const std::string DISK_RESOURCE_NAME = "disk";
...
const std::string USED_IDS_KEY = "used_ids";
...
const std::string DISK_MOUNT_POINT = "YR_DISK_MOUNT_POINT";
