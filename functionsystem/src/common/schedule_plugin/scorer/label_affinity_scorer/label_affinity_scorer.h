...
#ifndef FUNCTIONSYSTEM_LABEL_AFFINITY_SCORE_H
#define FUNCTIONSYSTEM_LABEL_AFFINITY_SCORE_H
...
class LabelAffinityScorer : public schedule_framework::ScorePlugin {
public:
    explicit LabelAffinityScorer(bool isRelaxed): isRelaxed_(isRelaxed) {}
    ~LabelAffinityScorer() override = default;
...
#endif // FUNCTIONSYSTEM_LABEL_AFFINITY_SCORE_H
