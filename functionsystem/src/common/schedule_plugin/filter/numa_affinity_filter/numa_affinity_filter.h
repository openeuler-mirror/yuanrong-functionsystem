...
#ifndef FUNCTIONSYSTEM_NUMA_AFFINITY_FILTER_H
#define FUNCTIONSYSTEM_NUMA_AFFINITY_FILTER_H
...
class NUMAAffinityFilter : public schedule_framework::FilterPlugin {
public:
    NUMAAffinityFilter() = default;
    ~NUMAAffinityFilter() override = default;
...
private:
    bool NeedNUMAAffinityFilter(const resource_view::InstanceInfo& instance) const;
    bool PerformNUMAFilter(
...
#endif // FUNCTIONSYSTEM_NUMA_AFFINITY_FILTER_H
