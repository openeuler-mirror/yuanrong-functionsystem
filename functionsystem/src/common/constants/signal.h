...
inline std::string SignalToString(int32_t signal) 
{
    static std::unordered_map<int32_t, std::string> signalMap = {
        {SHUT_DOWN_SIGNAL, "SHUT_DOWN_SIGNAL"}, {SHUT_DOWN_SIGNAL_ALL, "SHUT_DOWN_SIGNAL_ALL"},
        {SHUT_DOWN_SIGNAL_SYNC, "SHUT_DOWN_SIGNAL_SYNC"}, {SHUT_DOWN_SIGNAL_GROUP, "SHUT_DOWN_SIGNAL_GROUP"}, 
        {GROUP_EXIT_SIGNAL, "GROUP_EXIT_SIGNAL"}, {FAMILY_EXIT_SIGNAL, "FAMILY_EXIT_SIGNAL"}, 
        {APP_STOP_SIGNAL, "APP_STOP_SIGNAL"}, {REMOVE_RESOURCE_GROUP, "REMOVE_RESOURCE_GROUP"}, 
        {SUBSCRIBE_SIGNAL, "SUBSCRIBE_SIGNAL"}, {NOTIFY_SIGNAL, "NOTIFY_SIGNAL"}, 
        {UNSUBSCRIBE_SIGNAL, "UNSUBSCRIBE_SIGNAL"},  
        {INSTANCE_CHECKPOINT_SIGNAL, "INSTANCE_CHECKPOINT_SIGNAL"}, {INSTANCE_TRANS_SUSPEND_SIGNAL, "INSTANCE_TRANS_SUSPEND_SIGNAL"}, 
        {INSTANCE_SUSPEND_SIGNAL, "INSTANCE_SUSPEND_SIGNAL"}, {INSTANCE_RESUME_SIGNAL, "INSTANCE_RESUME_SIGNAL"}, 
        {GROUP_SUSPEND_SIGNAL, "GROUP_SUSPEND_SIGNAL"}, {GROUP_RESUME_SIGNAL, "GROUP_RESUME_SIGNAL"}, 
    };
