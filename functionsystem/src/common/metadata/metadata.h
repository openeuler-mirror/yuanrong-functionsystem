...
static inline void GetInitializer(FunctionMeta &funcMeta, nlohmann::json &extendedMetaData)
{
...
static inline void GetUserAgency(FunctionMeta &funcMeta, nlohmann::json &extendedMetaData)
{
