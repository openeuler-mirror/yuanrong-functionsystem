...
#ifndef RUNTIME_MANAGER_CONFIG_LANGUAGE_GO_STRATEGY_H
#define RUNTIME_MANAGER_CONFIG_LANGUAGE_GO_STRATEGY_H
...
#endif  // RUNTIME_MANAGER_CONFIG_LANGUAGE_GO_STRATEGY_H
