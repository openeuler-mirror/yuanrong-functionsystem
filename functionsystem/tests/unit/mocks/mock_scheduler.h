...
#ifndef TEST_UNIT_MOCKS_MOCK_SCHEDULER_H
#define TEST_UNIT_MOCKS_MOCK_SCHEDULER_H
...
public:
    MockScheduler() : schedule_decision::Scheduler()
    {
    }
    ...
    MOCK_METHOD(litebus::Future<schedule_decision::GroupScheduleResult>, GroupScheduleDecision,
                (const std::shared_ptr<schedule_decision::GroupSpec> &spec), (override));
};

}  // namespace functionsystem::test

#endif  // TEST_UNIT_MOCKS_MOCK_SCHEDULER_H
